# Image Integration Testing Playbook (from emergentintegrations)
...
## Endpoints to test for PrakritiDx
- POST /api/upload/selfie (multipart image/jpeg or image/png)
- POST /api/upload/lab-report (multipart image or PDF)
- POST /api/report/full (post-payment, uses uploaded images for vision analysis)
